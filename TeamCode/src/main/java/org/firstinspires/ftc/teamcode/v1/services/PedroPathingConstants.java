...
public final class PedroPathingConstants {
    private PedroPathingConstants() {
    }
    ...
    public static Follower createFollower(HardwareMap hardwareMap) {
        ...
        MecanumConstants driveConstants = new MecanumConstants()
                ...
                // Drivetrain names are strict and must exactly match RobotHardwareNames/config.
                .rightFrontMotorName(RobotHardwareNames.RIGHT_FRONT_MOTOR)
    ...
    private static void applyFrontGearCompensation(HardwareMap hardwareMap) {
        ...
        applyMaxRpmFraction(hardwareMap, RobotHardwareNames.LEFT_FRONT_MOTOR, cappedFraction);
        applyMaxRpmFraction(hardwareMap, RobotHardwareNames.RIGHT_FRONT_MOTOR, cappedFraction);
    }
